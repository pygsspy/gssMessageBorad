...
$route['*']['/post'] = array('MainController', 'post');
#$route['post']['/post'] = array('MainController', 'post');
$route['*']['/list'] = array('MainController', 'lists');
$route['*']['/page/:p'] = array('MainController', 'lists');
